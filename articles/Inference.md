...
#> ℹ Starting clustering of clone C0 mutationsℹ Score(s): ELBO = -1461.843. Fit converged in 6 steps, ε = 1e-10.
...
#> 2 S2      0.00681 0.362 0.0286 0.396     1 FALSE     FALSE    
...
#> ℹ Starting clustering of clone C1 mutations• Clusters: π = 25% [C3], 25% [C5], 25% [C8], 13% [C2], and 13% [C4], with π >
#> 0.
#> ℹ Starting clustering of clone C1 mutations• Binomials: θ = <0.18, 0, 0.01, 0> [C3], <0, 0.14, 0.01, 0> [C5], <0, 0.08,
#> 0.01, 0.15> [C8], <0.2, 0.01, 0.02, 0.23> [C2], and <0.43, 0.01, 0.02, 0.32>
#> [C4].
#> ℹ Starting clustering of clone C1 mutationsℹ Score(s): ELBO = -4571.199. Fit converged in 7 steps, ε = 1e-10.
...
#>   cluster   t1.l1   t2.l1  t1.l2 t2.l2 nMuts is.clonal is.driver
#>   <chr>     <dbl>   <dbl>  <dbl> <dbl> <dbl> <lgl>     <lgl>    
#> 1 S1      0.198   0.00559 0.0170 0.225     1 FALSE     FALSE    
#> 2 S2      0.184   0.00280 0      0         2 FALSE     FALSE    
#> 3 S3      0.430   0.00559 0.0170 0.318     1 FALSE     FALSE    
#> 4 S4      0.00162 0.142   0      0         2 FALSE     FALSE    
#> 5 S5      0.00161 0.0756  0.0123 0.147     2 FALSE     TRUE     
#> 6 C1      1       1       1      1         1 TRUE      FALSE
#> ✔ Trees per region 6, 2, 5, 5
#> ℹ Starting phylogeny inference of clone C1ℹ Total 24 tree structures - search is exahustive
...
#> ℹ Starting clustering of clone C4 mutations• Clusters: π = 50% [C4], 17% [C1], 17% [C2], and 17% [C5], with π > 0.
#> ℹ Starting clustering of clone C4 mutations• Binomials: θ = <0.15, 0, 0.01, 0> [C4], <0.36, 0, 0.02, 0.28> [C1], <0, 0,
#> 0.02, 0.29> [C2], and <0.19, 0.22, 0.3, 0.2> [C5].
#> ℹ Starting clustering of clone C4 mutationsℹ Score(s): ELBO = -3594.639. Fit converged in 6 steps, ε = 1e-10.
...
#>   cluster t1.l1   t2.l1  t1.l2 t2.l2 nMuts is.clonal is.driver
#>   <chr>   <dbl>   <dbl>  <dbl> <dbl> <dbl> <lgl>     <lgl>    
#> 1 S1      0.358 0.00473 0.0171 0.275     1 FALSE     FALSE    
#> 2 S2      0     0       0.0185 0.292     1 FALSE     FALSE    
#> 3 S3      0.146 0.00158 0      0         3 FALSE     TRUE     
...
#> ℹ Starting clustering of clone C7 mutationsℹ Score(s): ELBO = -1584.528. Fit converged in 5 steps, ε = 1e-10.
...
#>   cluster  t1.l1   t2.l1 t1.l2 t2.l2 nMuts is.clonal is.driver
#>   <chr>    <dbl>   <dbl> <dbl> <dbl> <dbl> <lgl>     <lgl>    
#> 1 S1      0.0105 0.112   0     0         1 FALSE     TRUE     
#> 2 S2      0.396  0.00235 0.308 0.348     1 FALSE     FALSE    
