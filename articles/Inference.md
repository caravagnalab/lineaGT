...
#> ℹ Starting clustering of clone C0 mutations• Clusters: π = 67% [C2] and 33% [C1], with π > 0.
#> ℹ Starting clustering of clone C0 mutations• Binomials: θ = <0.09, 0.19, 0.01, 0> [C2] and <0.01, 0.36, 0.03, 0.4> [C1].
#> ℹ Starting clustering of clone C0 mutationsℹ Score(s): ELBO = -1461.836. Fit converged in 5 steps, ε = 1e-10.
...
#> 1 S1      0.00681 0.362 0.0288 0.396     1 FALSE     FALSE    
...
#> ℹ Starting clustering of clone C1 mutations• Clusters: π = 25% [C1], 25% [C2], 25% [C4], and 25% [C6], with π > 0.
#> ℹ Starting clustering of clone C1 mutations• Binomials: θ = <0.18, 0, 0.01, 0> [C1], <0, 0.14, 0.01, 0> [C2], <0, 0.08,
#> 0.01, 0.15> [C4], and <0.31, 0, 0.01, 0.27> [C6].
#> ℹ Starting clustering of clone C1 mutationsℹ Score(s): ELBO = -4567.679. Fit converged in 7 steps, ε = 1e-10.
...
#> 2 S2      0.00162 0.142   0       0         2 FALSE     FALSE    
#> 3 S3      0.00162 0.0756  0.0123  0.147     2 FALSE     TRUE     
#> 4 S4      0.314   0.00280 0.00863 0.271     2 FALSE     FALSE    
...
#> ℹ Starting clustering of clone C4 mutations• Clusters: π = 50% [C4], 17% [C1], 17% [C3], and 17% [C6], with π > 0.
#> ℹ Starting clustering of clone C4 mutations• Binomials: θ = <0.15, 0, 0.01, 0> [C4], <0, 0, 0.02, 0.29> [C1], <0.19, 0.22,
#> 0.3, 0.2> [C3], and <0.36, 0, 0.02, 0.28> [C6].
#> ℹ Starting clustering of clone C4 mutationsℹ Score(s): ELBO = -3594.743. Fit converged in 6 steps, ε = 1e-10.
...
#>   cluster t1.l1   t2.l1  t1.l2 t2.l2 nMuts is.clonal is.driver
#>   <chr>   <dbl>   <dbl>  <dbl> <dbl> <dbl> <lgl>     <lgl>    
#> 1 S1      0     0       0.0186 0.292     1 FALSE     FALSE    
#> 2 S2      0.192 0.222   0.296  0.198     1 FALSE     FALSE    
#> 3 S3      0.146 0.00159 0      0         3 FALSE     FALSE    
#> 4 S4      0.358 0.00476 0.0171 0.275     1 FALSE     TRUE     
...
#> ℹ Starting clustering of clone C7 mutationsℹ Score(s): ELBO = -1584.554. Fit converged in 5 steps, ε = 1e-10.
...
#>   cluster  t1.l1   t2.l1 t1.l2 t2.l2 nMuts is.clonal is.driver
#>   <chr>    <dbl>   <dbl> <dbl> <dbl> <dbl> <lgl>     <lgl>    
#> 1 S1      0.0104 0.112   0     0         1 FALSE     TRUE     
#> 2 S2      0.396  0.00236 0.308 0.348     1 FALSE     FALSE    
